# Challenge students to come up with their own recursive definition for the Fibonacci sequence. 
# They can write a function in Python that takes an integer input n and returns the nth Fibonacci number using the recursive definition they came up with.
